...
class Library
{
    ...
    public string this[int bookId]
    {
        get
        {
            return books.ContainsKey(bookId) ? books[bookId] : "Book not found";
        }
        set
        {
            books[bookId] = value;
    ...
    // =========================
    // Access books using Book Title (read-only)
